...
namespace WeAreDevs_API
{
    ...
    {
        private String name = "FoxSploit"; // Your Exploit's name.
        ...
        public bool IsUpdated()
        {
            ...
            {
                MessageBox.Show("Could not check for updates. Did your firewall block us?", "Error");
            }
            return result;
        }
        ...
        public bool LaunchExploit()
        {
            ...
            else if (this.IsUpdated())
            {
                ...
                {
                    MessageBox.Show("Could not download updates. Did your firewall block us?", "Error");
                }
            }
            else
            {
